...
const ClubPage = () => {
  ...
  return (
    <>
      ...
      {post ? (
        <div className="container w-full min-h-[60vh] grid place-items-center md:max-w-6xl mx-auto pt-40">
          <div className="w-full px-4 md:px-6 text-gray-800 leading-normal text-xl">
